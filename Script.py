...
🔥 𝐀𝐫𝐭𝐢𝐬𝐭 : <a href=https://t.me/Oitsz_ram>🍁𝐌𝐢𝐚☔</a>
🍻 𝐃𝐞𝐯𝐨𝐥𝐨𝐩𝐞𝐫 : <a href=https://t.me/itsz_ram>🎋𝐓𝐡𝐮𝐥𝐚𝐬𝐮🦞</a>
✍️ 𝐆𝐫𝐚𝐝𝐮𝐚𝐭𝐞 : <a href=https://t.me/itsz_ram>🛬𝐒𝐢𝐯𝐚𝐧𝐢🚦</a>
♠ 𝐊𝐨𝐥𝐚𝐫𝐮 : <a href=https://t.me/itsz_ram>🎭𝐌𝐚𝐥𝐚𝐚🔥</a>
👨‍🔧 𝐇𝐞𝐥𝐩𝐞𝐫 : <a href=https://t.me/itsz_ram>🗽𝐉𝐞𝐞𝐯𝐢🌿</a>
⚜️ 𝐐𝐭𝐯𝐬𝐨𝐟𝐟𝐢𝐜𝐢𝐚𝐥 : <a href=https://t.me/QTVS_BOT_X_CLOUD>🥀𝐌𝐚𝐫𝐯𝐞𝐥🎋</a></b>"""

    SOURCE_TXT = """𝐓𝐡𝐢𝐬 𝐈𝐬 𝐀𝐧 𝐎𝐩𝐞𝐧-𝐒𝐨𝐮𝐫𝐜𝐞 𝐏𝐫𝐨𝐣𝐞𝐜𝐭 𝐁𝐲 @SMD_Owner

- 𝟏𝟎𝟎﹪ 𝐂𝐨𝐝𝐞𝐝 𝐁𝐲 <a href=https://t.me/itsz_ram>🌿𝐑𝐨𝐥𝐞𝐱🦞</a>
...
sᴛᴇᴘ 𝟸 : ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ Aɴʏ <a href=https://Mplaylink.com/ref/Samar>Sʜᴏʀᴛᴇɴᴇʀ Wᴇʙsɪᴛᴇ</a>.

sᴛᴇᴘ 𝟹 : ꜰᴏʟʟᴏᴡ ᴛʜᴇsᴇ <a href=https://t.me/TamilMov_Tutorial/3> ɪɴꜱᴛʀᴜᴄᴛɪᴏɴꜱ </a>Tᴏ ᴄᴏɴɴᴇᴄᴛ sʜᴏʀᴛᴇɴᴇʀ.
...
<b>
╭─────── • ◆ • ───────╮
🔅 𝐌𝐚𝐢𝐧 𝐇𝐮𝐛:  <a href="https://t.me/TamilMov_LinkZz">♻️𝐂𝐥𝐢𝐜𝐤♻️</a>
╰─────── • ◆ • ───────╯

=========== • ✠ • ===========
▫️ 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 : @TamilMov_chat
▫️ 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 : @TamilMov_LinkZz
=========== • ✠ • ===========</b>"""
    IMDB_TEMPLATE_TXT = """
<b>Query: {qurey}
